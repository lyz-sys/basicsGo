...
func (x *OrderRequest) Reset() {
	*x = OrderRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_order_stream_proto_msgTypes[0]
...
func (*OrderRequest) Descriptor() ([]byte, []int) {
	return file_order_stream_proto_rawDescGZIP(), []int{0}
}
...
func (x *OrderInfo) Reset() {
	*x = OrderInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_order_stream_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OrderInfo) Descriptor() ([]byte, []int) {
	return file_order_stream_proto_rawDescGZIP(), []int{1}
}
...
var File_order_stream_proto protoreflect.FileDescriptor

var file_order_stream_proto_rawDesc = []byte{
	0x0a, 0x12, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2e, 0x70,
	...
	0x0b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x4d, 0x0a, 0x0c,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3d, 0x0a, 0x0c,
	...
	0x64, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x28, 0x01, 0x30, 0x01, 0x42, 0x13, 0x5a, 0x11, 0x2e,
	0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x3b, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_order_stream_proto_rawDescOnce sync.Once
	file_order_stream_proto_rawDescData = file_order_stream_proto_rawDesc
)

func file_order_stream_proto_rawDescGZIP() []byte {
	file_order_stream_proto_rawDescOnce.Do(func() {
		file_order_stream_proto_rawDescData = protoimpl.X.CompressGZIP(file_order_stream_proto_rawDescData)
	})
	return file_order_stream_proto_rawDescData
}

var file_order_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_order_stream_proto_goTypes = []interface{}{
	(*OrderRequest)(nil), // 0: message.OrderRequest
	(*OrderInfo)(nil),    // 1: message.OrderInfo
}
var file_order_stream_proto_depIdxs = []int32{
...
func init() { file_order_stream_proto_init() }
func file_order_stream_proto_init() {
	if File_order_stream_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_order_stream_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_order_stream_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_order_stream_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_order_stream_proto_goTypes,
		DependencyIndexes: file_order_stream_proto_depIdxs,
		MessageInfos:      file_order_stream_proto_msgTypes,
	}.Build()
	File_order_stream_proto = out.File
	file_order_stream_proto_rawDesc = nil
	file_order_stream_proto_goTypes = nil
	file_order_stream_proto_depIdxs = nil
}
...
func (c *orderServiceClient) GetOrderInfo(ctx context.Context, opts ...grpc.CallOption) (OrderService_GetOrderInfoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_OrderService_serviceDesc.Streams[0], "/message.OrderService/GetOrderInfo", opts...)
	if err != nil {
		return nil, err
	}
